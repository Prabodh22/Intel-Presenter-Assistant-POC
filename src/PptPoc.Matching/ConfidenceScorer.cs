...
public class ConfidenceScorer
{
    ...
    public double ComputeConfidence(double rawScore, MatchType type, SlideElement element)
    {
        ...
        // Removed massive -0.20 penalty for images. 
        // We want image targets to compete fairly based on their OCR content.
        /*
        ...
        */
        ...
        // Slight penalty for titles to avoid matching tiny title fragments over main content, 
        // but not so much (-0.15 previously) that direct title callouts fail.
