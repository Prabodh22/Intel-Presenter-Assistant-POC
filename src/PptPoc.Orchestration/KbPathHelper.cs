...
public static class KbPathHelper
{
    ...
    /// Uses the shared runtime artifact directory so YAML, logs, and NDJSON
    /// land together under the workspace logs folder during development.
    /// Override in tests to point at a temp folder.
    /// </summary>
    public static string DefaultKbDirectory { get; set; } = RuntimeArtifactPaths.LogsDirectory;
